...
# n_components_95 = np.argmax(evr_cumsum >= 0.95) + 1
# n_components_99 = np.argmax(evr_cumsum >= 0.99) + 1
# n_components_999 = np.argmax(evr_cumsum >= 0.999) + 1
# n_components_1 = np.argmax(evr_cumsum >= 1.0) + 1
...
print('0.95 이상 : ' , np.min(np.where(evr_cumsum>=0.95)))
print('0.99 이상 : ', np.min(np.where(evr_cumsum>=0.99)))
print('0.999 이상 :', np.min(np.where(evr_cumsum>=0.999)))
print('1.0 일 때 :', np.argmax(evr_cumsum))
