...
#4. 평가, 예측
print("==================== 2. MCP 출력 =========================")
model = load_model('C:/ai5/_save/keras55/k55_jena0809_1551_0060-3.412181.hdf5')
results = model.evaluate(x, y, batch_size=300) # results 결과 / evaluate 평가
...
submit.to_csv(path + "jena_김지혜.csv", index=False)

print("range(144)개의 결과 : ", y_pred)
print("로스는 : " , results[0])
print("RMSE : ", rmse)

# 로스는 :  3.1943178176879883 / RMSE :  2.099804326743509
